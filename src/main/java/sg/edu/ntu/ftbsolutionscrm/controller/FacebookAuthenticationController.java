...
// LoggerFactory.getLogger(FacebookAuthenticationController.class);

// @Autowired
// private FacebookAuthenticationService facebookAuthenticationService;

// @PostMapping("/facebook-login")
// public ResponseEntity<?> authenticateWithFacebook(@RequestBody Map<String,
// String> requestBody) {
...
// facebookAuthenticationService.authenticateWithFacebook(facebookUid);
